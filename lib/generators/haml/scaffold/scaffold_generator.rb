  ...
  module Generators
    class ScaffoldGenerator < Haml::Generators::Base
      ...
      def copy_layout_file
        ...
        template "layout.haml", File.join("app/views/layouts", controller_class_path, "#{controller_file_name}.haml")
      end

      protected
        def copy_view(view)
          template "#{view}.haml", File.join("app/views", controller_file_path, "#{view}.haml")
        end
    end
  end
end
